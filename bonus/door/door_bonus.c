...
/*   Updated: 2026/02/01 03:13:43 by ilyas-guney      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (c == DOOR_PIKACHU || c == DOOR_BULBASAUR || c == DOOR_CHARMANDER);
}
...
int	get_pokemon_type(char c)
{
	...
	else if (c == DOOR_BULBASAUR)
		return (POKEMON_BULBASAUR);
	else if (c == DOOR_CHARMANDER)
